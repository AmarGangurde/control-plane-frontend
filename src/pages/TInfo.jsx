            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="space-y-6 text-slate-300 leading-relaxed">
                        ...
                        <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name wrexer.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>

                        <p>The Platform is owned by Amarnath Gangurde, a company incorporated under the Companies Act, 1956 with its registered office at Ho no 895 , Suchakar nagar , satara parisar , Chh Sambhaji Nagar (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..</p>
                        ...
                        <p className="font-bold text-white uppercase tracking-wider">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING..</p>

                        <h2 className="text-xl font-semibold text-white mt-8">Terms of Use:</h2>
