            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="space-y-6 text-slate-300 leading-relaxed">
                        ...
                        <h2 className="text-xl font-semibold text-white mt-8">Security Precautions</h2>
                        ...
                        <h2 className="text-xl font-semibold text-white mt-8">Data Deletion and Retention</h2>
                        ...
                        <h2 className="text-xl font-semibold text-white mt-8">Grievance Officer</h2>
                        <div className="p-4 bg-white/5 rounded-lg border border-white/5 space-y-2">
                            <p><span className="text-slate-500">Address:</span> Ho no 895, Suchakar nagar, satara parisar, Chh Sambhaji Nagar</p>
                            <p><span className="text-slate-500">Contact:</span> Monday - Friday (9:00 - 18:00)</p>
                        </div>
                    </div>
                </motion.div>
            </div>
